...
import com.example.elite_classroom.PendingAdapter;
...
public class PendingFragment extends Fragment {
    ...
    TextView tvLoading;
    private static final String URL = "https://elite-classroom-server.herokuapp.com/api/todos/notTurnedIn";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, object, new Response.Listener<JSONObject>() {
            ...
            {
                try {
                    JSONArray pendingAssignments= new JSONArray(response.get("data").toString());
                    rvPending.setAdapter(new PendingAdapter(getContext(), pendingAssignments));
