...
public class PendingAdapter  extends RecyclerView.Adapter<PendingAdapter.pendingViewHolder>
{
    ...
    public PendingAdapter(Context context, JSONArray data)
    {
    ...
    @NonNull
    @Override
    public PendingAdapter.pendingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.rvpending_item, parent, false);
